...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 8, vars: 0, consts: [[1, "container"], [1, "row"], [1, "col-xs-12", "col-sm-6"], [1, "col-12"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
TabsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TabsComponent, selectors: [["app-tabs"]], decls: 12, vars: 0, consts: [[1, "nav", "nav-tabs"], [1, "nav-item"], ["routerLink", "/characters/all", "routerLinkActive", "active", 1, "nav-link"], ["routerLink", "/characters/light", "routerLinkActive", "active", 1, "nav-link"], ["routerLink", "/characters/dark", "routerLinkActive", "active", 1, "nav-link"]], template: function TabsComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! C:\Users\mccoo\Documents\projects\star-wars\src\main.ts */"./src/main.ts");
